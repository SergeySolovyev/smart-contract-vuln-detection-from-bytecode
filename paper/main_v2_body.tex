...
\vDlBestName{} at $p = \vDlPsign$ (Figure~\ref{fig:heatmap-v2}). Across the family of \vDlNConfigs{}
comparisons we apply a Holm correction; whether this particular comparison
survives it is reported as \vDlHolm. At the model level, \vDlLosing{} of
